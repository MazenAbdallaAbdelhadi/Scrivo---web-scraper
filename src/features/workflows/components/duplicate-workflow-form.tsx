...
import { duplicateWorkflowSchema, IDuplicateWorkflowSchema } from "../schemas";
import { DuplicateWorkflow } from "@/server/workflows/actions/duplicate-workflow";
...
export const DuplicateWorkflowForm = ({
  ...
  const form = useForm<IDuplicateWorkflowSchema>({
  ...
  const onSubmit = useCallback(
    (values: IDuplicateWorkflowSchema) => {
      toast.loading("Duplicationg workflow...", { id: "duplicate-workflow" });
      mutate(values);
    },
    [mutate]
  );
